...
<table id="datatable" class="table table-striped table-bordered">
	<thead>
		<tr>
			...
			<th width="200"><strong>Nama Bagian</strong></th>
			<th width="100" align="center"><a href="<?php echo $baseURL;?>bagian/addsup" target"_self">
				<span class="fa fa-plus-circle"></span> Add Data</a></th>
		</tr>
	</thead>
	<?php
	/* PENCARIAN BERDASARKA DATA DI TABEL*/
	$mySql ="SELECT * FROM bagian $filterSQL ORDER BY nm_bagian DESC, kd_bagian DESC";
	...
	<tr>
		...
		<td align="center">
			<?php if (!$_SESSION['SES_PENGGUNA']):?>
				<a href="<?php echo $baseURL;?>bagian/editsup?kode=<?php echo $Kode; ?>">
					<span class="fa fa-pencil"></span></a>
				<a href="<?php echo $baseURL;?>bagian/deletesup?kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" onclick="return confirm('Apakah anda yakin ingin menghapus data <?php echo $Kode; ?>')">
