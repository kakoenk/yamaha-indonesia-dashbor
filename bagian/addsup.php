	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3>General <small>Bagian</small></h3>
			</div>
		</div>
...
if(isset($_POST['btnSimpan'])){
	...
	$txtBagian = $_POST['txtBagian']; //xyz
	$txtBagian = str_replace("'","&acute;",$txtBagian);//menghalangi penulisan tanda petik
	...
	$pesanError = array();
	if (trim($txtBagian)==""){
		$pesanError[]="Nama Bagian<b>tidak boleh kosong !";
	}
	//batas untuk menampilkan pesan error

	//CEK APAKAH NAMA BARNG SUDAH ADA ATAU BELUM
	$sqlCek="SELECT * FROM bagian WHERE nm_bagian='$txtBagian'";
	$qryCek=mysqli_query($koneksidb, $sqlCek);

	//KALAU SUDAH ADA WARNING DAN KELUAR
	if(mysqli_num_rows($sqlCek)>=1){
		$pesanError[]= "Maaf, Nama bagian <b> $txtBagian </b> sudah dipakai, silahkan ganti dengan nama yang baru";
	}
...
<form id="theform" data-parslay-validate class="form-horizontal form-label-left" 
	...
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nama Bagian<span class="required">*</span></label>
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" id="first-name"  class="form-control col-md-7 col-xs-12" name="txtBagian"
